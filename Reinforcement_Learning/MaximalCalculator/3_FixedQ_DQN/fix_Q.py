...
class FixedQ:
    def __init__(self, actions, learning_rate=0.1, gamma=0.9, e_greedy=0):
        ...
        self.fq_model = tf.models.Sequential([
            tf.layers.Dense(8, input_shape = (1, ), activation = 'linear'), 
            tf.layers.Dense(8, activation = 'linear'),
    ...
    def learn(self, s, a, r, s_):
        ...
        q_predict = q_list[a]
        q_target = r + self.gamma * (max(self.dump.predict([s_])[0]))
